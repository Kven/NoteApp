	...
	public struct Coordinates
	{
		...
		public Coordinates (int x, int y)
		{
			if (x >= 50 && x <= 255)
				...
				throw new ArgumentException("Координата Х не может быть меньше 50 или больше 240");

			if (y >= 50 && y <= 266)
				Y = y;
			else
				throw new ArgumentException("Координата У не может быть меньше 50 или больше 250");
		}
	}
